...
#Preview (traits: .controlPreview) {
    ...
    ScrollView {
        ControlCompactDatePicker(input: $date)
        
        ControlCompactDatePicker(input: $date, includeTime: false)
        ControlCompactDatePicker(input: $date, includeDate: false)
        
        ControlCompactDatePicker(input: $date, validStartDate: .now.addingTimeInterval(-100000000), validEndDate: .now.addingTimeInterval(1000))
